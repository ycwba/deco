...
@media (max-width: 768px) {
  .countdown-container {
    ...
    top: 10px;
    left: 50%;
    transform: translateX(-50%) scale(0.7); /* 整体缩小 20% */
    width: max-content;
  }
...
@media (max-width: 768px) {
  :global(body.reading-mode) .countdown-container {
  
    opacity: 0;           /* 渐隐 */
    pointer-events: none; /* 禁止点击，防止点到隐藏的元素 */
    transform: translateX(-50%) translateY(-20px); /* 稍微往上飘一点消失 */
